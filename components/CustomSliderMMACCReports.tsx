    ...
    >
      {combinedData && status === "success" ? (
        combinedData.map((el, index) => (
          <SwiperSlide
            key={index}
            className={index === 0 || index === 1 ||index === 2 || index === 3 || index === 5 || index === 4 || index === 7 || index === 6 || index === 8 || index === 10  || index === 12 || index === 13 || index === 14 || index === 15 || index === 16 || index === 17 ? "hidden-slide" : ""}
          >
            {"result" in el ? (
              <SliderItem
                id={el.result.id}
